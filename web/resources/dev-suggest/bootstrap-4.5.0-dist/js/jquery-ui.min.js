...
(function (t) {
    ...
    t.uiBackCompat !== !1 && (f = t.effects.define("transfer", function (e, i) {
        ...
        return "area" === l ? (n = i.parentNode, o = n.name, i.href && o && "images.test.map" === n.nodeName.toLowerCase() ? (a = t("img[usemap='#" + o + "']"), a.length > 0 && a.is(":visible")) : !1) : (/^(input|select|textarea|button|object)$/.test(l) ? (r = !i.disabled, r && (h = t(i).closest("fieldset")[0], h && (r = !h.disabled))) : r = "a" === l ? i.href || s : s, r && t(i).is(":visible") && e(t(i)))
    }, t.extend(t.expr[":"], {
