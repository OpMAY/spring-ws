...
jQuery.easing.jswing = jQuery.easing.swing, jQuery.extend(jQuery.easing, {
    def: "easeOutQuad", swing: function (t, e, i, n, a) {
    ...
    if (!t.jQuery) {
        ...
        i.isWindow = function (t) {
            ...
            if (n) {
                if (o) for (; r > a && !1 !== i.apply(t[a], n); a++) ; else for (a in t) if (!1 === i.apply(t[a], n)) break
            } else if (o) for (; r > a && !1 !== i.call(t[a], a, t[a]); a++) ; else for (a in t) if (!1 === i.call(t[a], a, t[a])) break;
            return t
            ...
            var t, e, n, a, r, o, s = arguments[0] || {}, l = 1, u = arguments.length, d = !1;
            for ("boolean" == typeof s && (d = s, s = arguments[l] || {}, l++), "object" != typeof s && "function" !== i.type(s) && (s = {}), l === u && (s = this, l--); u > l; l++) if (null != (r = arguments[l])) for (a in r) t = s[a], s !== (n = r[a]) && (d && n && (i.isPlainObject(n) || (e = i.isArray(n))) ? (e ? (e = !1, o = t && i.isArray(t) ? t : []) : o = t && i.isPlainObject(t) ? t : {}, s[a] = i.extend(d, o, n)) : void 0 !== n && (s[a] = n));
            return s
    ...
    return function (t, e, i, n) {
        ...
        function o(t, i, n, a) {
            ...
            var w = y ? new Float32Array(v) : new Array(v), k = !1, S = function (e) {
                return k || h(), t === i && n === a ? e : 0 === e ? 0 : 1 === e ? 1 : l(function (e) {
                    for (var i = 0, a = 1, r = v - 1; a != r && w[a] <= e; ++a) i += b;
                    var o = i + (e - w[--a]) / (w[a + 1] - w[a]) * b, s = u(o, t, n);
        ...
        function l(t) {
            if (t) {
                ...
                for (var a = 0; i > a; a++) if (v.State.calls[a]) {
                    var o = v.State.calls[a], s = o[0], c = o[2], h = o[3], p = !!h, g = null;
                    h || (h = v.State.calls[a][3] = e - 16);
                    for (var m = Math.min((e - h) / c.duration, 1), b = 0, x = s.length; x > b; b++) {
                        var k = s[b], S = k.element;
                        if (r(S)) {
                            var C = !1;
                            ...
                            for (var M in c.visibility !== n && "hidden" !== c.visibility && y.setPropertyValue(S, "visibility", c.visibility), k) if ("element" !== M) {
                                ...
                                if (T.currentValue = P, "tween" === M) g = P; else {
                                    if (y.Hooks.registered[M]) {
                                        var I = y.Hooks.getRoot(M), D = r(S).rootPropertyValueCache[I];
            ...
            for (var i = v.State.calls[t][0], a = v.State.calls[t][1], o = v.State.calls[t][2], s = v.State.calls[t][4], l = !1, u = 0, c = i.length; c > u; u++) {
                ...
                if (e || o.loop || ("none" === o.display && y.setPropertyValue(h, "display", o.display), "hidden" === o.visibility && y.setPropertyValue(h, "visibility", o.visibility)), !0 !== o.loop && (d.queue(h)[1] === n || !/\.velocityQueueEntryFlag/i.test(d.queue(h)[1])) && r(h)) {
                    ...
                    d.each(y.Lists.transforms3D, function (t, e) {
                        var i = /^scale/.test(e) ? 1 : 0, a = r(h).transformCache[e];
                ...
                }), v(h, "reverse", {loop: !0, delay: o.delay})), !1 !== o.queue && d.dequeue(h, o.queue)
            }
            v.State.calls[t] = !1;
        ...
        if (!(7 >= c)) {
            ...
            var b = function () {
                ...
                function i(i, n) {
                    var a = {dx: i.v, dv: t(i)}, r = e(i, .5 * n, a), o = e(i, .5 * n, r), s = e(i, n, o),
                        l = 1 / 6 * (a.dx + 2 * (r.dx + o.dx) + s.dx), u = 1 / 6 * (a.dv + 2 * (r.dv + o.dv) + s.dv);
                    return i.x = i.x + l * n, i.v = i.v + u * n, i
                }

                return function t(e, n, a) {
                    var r, o, s, l = {x: -1, v: 0, tension: null, friction: null}, u = [0], d = 0;
            ...
            var y = v.CSS = {
                ...
                Hooks: {
                    templates: {
                        ...
                        for (i in y.Hooks.templates) for (var t in a = (n = y.Hooks.templates[i])[0].split(" ")) {
                            var o = i + a[t], s = t;
                ...
                getPropertyValue: function (t, i, a, o) {
                    ...
                    if (!/^[\d-]/.test(l)) if (r(t) && r(t).isSVG && y.Names.SVGAttribute(i)) if (/^(height|width)$/i.test(i)) try {
                        l = t.getBBox()[i]
                    } catch (t) {
                        l = 0
                    } else l = t.getAttribute(i); else l = s(t, y.Names.prefixCheck(i)[0]);
            ...
            var x = function () {
                ...
                function o() {
                    function t(t) {
                        ...
                        if ("scroll" === P) {
                            var x, k, M, A = /^x$/i.test(u.axis) ? "Left" : "Top", _ = parseFloat(u.offset) || 0;
                    ...
                    var a, o = this, u = d.extend({}, v.defaults, w), c = {};
                        ...
                        default:
                            if (!d.isPlainObject(b) || f.isEmptyObject(b)) {
                                if (f.isString(b) && v.Redirects[b]) {
                                    var _ = (O = d.extend({}, w)).duration, I = O.delay || 0;
            ...
            return v.State.isMobile || i.hidden === n || i.addEventListener("visibilitychange", function () {
                ...
                v.Redirects["slide" + e] = function (t, i, a, r, o, s) {
                    var l = d.extend({}, i), u = l.begin, c = l.complete,
                ...
                v.Redirects["fade" + e] = function (t, i, a, r, o, s) {
                    var l = d.extend({}, i), u = {opacity: "In" === e ? 1 : 0}, c = l.complete;
    ...
    return function () {
        ...
        1: [function (t, e, i) {
                ...
                t.controllers.bar = t.DatasetController.extend({
                    dataElementType: a.Rectangle, initialize: function () {
                        ...
                        var i, n, a, r, o, s, l = this.chart, u = this.getMeta(), d = this.getValueScale(),
                            c = l.data.datasets, h = d.getRightValue(c[t].data[e]), f = d.options.stacked, p = u.stack,
                            g = 0;
                        if (f || void 0 === f && void 0 !== p) for (i = 0; i < t; ++i) (n = l.getDatasetMeta(i)).bar && n.stack === p && n.controller.getValueScaleId() === d.id && l.isDatasetVisible(i) && (a = d.getRightValue(c[i].data[e]), (h < 0 && a < 0 || h >= 0 && a > 0) && (g += a));
                        ...
                        var n = i.scale.options, a = "flex" === n.barThickness ? function (t, e, i) {
                                var n, a = e.pixels, r = a[t], o = t > 0 ? a[t - 1] : null,
                                    s = t < a.length - 1 ? a[t + 1] : null, l = i.categoryPercentage;
                                ...
                                var n, a, o = i.barThickness, s = e.stackCount, l = e.pixels[t];
                                return r.isNullOrUndef(o) ? (n = e.min * i.categoryPercentage, a = i.barPercentage) : (n = o * s, a = 1), {
                                    chunk: n / s,
                                    ratio: a,
                                    start: l - n / 2
                                }
                            }(e, i, n), o = this.getStackIndex(t, this.getMeta().stack),
                ...
                t.controllers.bubble = t.DatasetController.extend({
                    dataElementType: a.Point, update: function (t) {
                        ...
                        var i, n, a, o = this.chart, s = o.data.datasets[this.index], l = t.custom || {},
                            u = o.options.elements.point, d = r.options.resolve, c = s.data[e], h = {},
                ...
                t.controllers.doughnut = t.controllers.pie = t.DatasetController.extend({
                    dataElementType: a.Arc, linkScales: r.noop, getRingIndex: function (t) {
                        ...
                        var n = this, a = n.chart, o = a.chartArea, s = a.options, l = s.animation,
                            ...
                            g = i && l.animateScale ? 0 : n.innerRadius, m = i && l.animateScale ? 0 : n.outerRadius,
                ...
                t.controllers.line = t.DatasetController.extend({
                    datasetElementType: a.Line, dataElementType: a.Point, update: function (t) {
                        var i, n, a, o = this, s = o.getMeta(), l = s.dataset, u = s.data || [], d = o.chart.options,
                            c = d.elements.line, h = o.getScaleForId(s.yAxisID), f = o.getDataset(), p = e(f, d);
                        ...
                        var t, i = this.chart, n = this.getMeta(), a = n.data || [], o = i.chartArea, s = a.length,
                            l = 0;
            ...
            n._set("polarArea", {
                ...
                t.controllers.polarArea = t.DatasetController.extend({
                    dataElementType: a.Arc, linkScales: r.noop, update: function (t) {
                        var e, i, n, a = this, o = a.getDataset(), s = a.getMeta(), l = a.chart.options.startAngle || 0,
                            u = a._starts = [], d = a._angles = [];
                        ...
                        var n = this, a = n.chart, o = n.getDataset(), s = a.options, l = s.animation, u = a.scale,
                            d = a.data.labels, c = u.xCenter, h = u.yCenter, f = s.startAngle,
                            p = t.hidden ? 0 : u.getDistanceFromCenterForValue(o.data[e]), g = n._starts[e],
            ...
            "use strict";
            var n = t(22), a = t(23), r = t(26), o = t(46), s = t(29), l = t(31), u = t(49), d = t(32), c = t(34),
                h = t(36);
            e.exports = function (t) {
                function e(t) {
                ...
                t.types = {}, t.instances = {}, t.controllers = {}, o.extend(t.prototype, {
                    construct: function (e, i) {
                        ...
                        var a = u.acquireContext(e, i), s = a && a.canvas, l = s && s.height, d = s && s.width;
                        ...
                        var t = this, i = t.options, n = t.scales || {}, a = [],
                        ...
                        i.scales && (a = a.concat((i.scales.xAxes || []).map(function (t) {
                            ...
                            var a = i.options, s = a.id, l = o.valueOrDefault(a.type, i.dtype);
                            e(a.position) !== e(i.dposition) && (a.position = i.dposition), r[s] = !0;
                            var u = null;
                            if (s in n && n[s].type === l) (u = n[s]).options = a, u.ctx = t.ctx, u.chart = t; else {
            ...
            a.extend(r.prototype, {
                initialize: function () {
                    ...
                    return i && 1 !== t ? (r || (r = e._view = {}), a || (a = e._start = {}), function (t, e, i, a) {
                        ...
                        for (r = 0, o = p.length; r < o; ++r) if (d = i[s = p[r]], e.hasOwnProperty(s) || (e[s] = d), (l = e[s]) !== d && "_" !== s[0]) {
            ...
            "use strict";
            var n = t(3), a = t(26), r = t(46), o = t(34);
            e.exports = function () {
                function t(t, e, i) {
                    var n;
                ...
                function i(i, n, a) {
                    var o = document.defaultView, s = r._getParentNode(i), l = o.getComputedStyle(i)[n],
                        u = o.getComputedStyle(s)[n], d = e(l), c = e(u), h = Number.POSITIVE_INFINITY;
                ...
                r.configMerge = function () {
                    ...
                    var i, n, a = t.originalEvent || t, o = t.target || t.srcElement, s = o.getBoundingClientRect(),
                        l = a.touches;
                    ...
                    var u = parseFloat(r.getStyle(o, "padding-left")), d = parseFloat(r.getStyle(o, "padding-top")),
                        ...
                        f = s.right - s.left - u - c, p = s.bottom - s.top - d - h;
                    return {
            ...
            t(26)._set("global", {
                ...
                defaultFontFamily: "'SpoqaHanSansNeo', 'Pretendard', 'SCDream', 'Roboto', 'Noto Sans KR', sans-serif;",
                defaultFontSize: 12,
            ...
            e.exports = {
                defaults: {}, addBox: function (t, e) {
                    ...
                    if (t) {
                        ...
                        var v = e - l - u, b = i - d - c, y = b / 2, x = (e - v / 2) / (h.length + f.length),
                            w = (i - y) / (p.length + g.length), k = v, S = b, C = [];
            ...
            "use strict";
            var n = t(26), a = t(27), r = t(46), o = t(35);
            ...
            n._set("scale", {
                ...
                calculateTickRotation: function () {
                    var t = this, e = t.ctx, i = t.options.ticks, n = s(t._ticks), a = d(i);
                    e.font = a.font;
                    var o = i.minRotation || 0;
                    if (n.length && t.options.display && t.isHorizontal()) for (var l, u = r.longestText(e, a.font, n, t.longestTextCache), c = u, h = t.getPixelForTick(1) - t.getPixelForTick(0) - 6; c > h && o < i.maxRotation;) {
                        var f = r.toRadians(o);
                ...
                fit: function () {
                    var t = this, e = t.minSize = {width: 0, height: 0}, i = s(t._ticks), n = t.options, a = n.ticks,
                        o = n.scaleLabel, l = n.gridLines, h = n.display, f = t.isHorizontal(), p = d(a),
                    ...
                    if (a.display && h) {
                        var v = r.longestText(t.ctx, p.font, i, t.longestTextCache), b = r.numberOfLabelLines(i),
                        ...
                        if (f) {
                            ...
                            var C = u(t.ctx, i[0], p.font), M = u(t.ctx, i[i.length - 1], p.font);
                ...
                _autoSkip: function (t) {
                    var e, i, n, a, o = this, s = o.isHorizontal(), l = o.options.ticks.minor, u = t.length,
                        d = r.toRadians(o.labelRotation), c = Math.cos(d), h = o.longestLabelWidth * c, f = [];
                ...
                draw: function (t) {
                    ...
                    if (i.display) {
                        var a = e.ctx, o = n.global, s = i.ticks.minor, u = i.ticks.major || s, h = i.gridLines,
                            f = i.scaleLabel, p = 0 !== e.labelRotation, g = e.isHorizontal(),
                            m = s.autoSkip ? e._autoSkip(e.getTicks()) : e.getTicks(),
                            v = r.valueOrDefault(s.fontColor, o.defaultFontColor), b = d(s),
                            y = r.valueOrDefault(u.fontColor, o.defaultFontColor), x = d(u),
                            w = h.drawTicks ? h.tickMarkLength : 0,
                            k = r.valueOrDefault(f.fontColor, o.defaultFontColor), S = d(f),
                            C = r.options.toPadding(f.padding), M = r.toRadians(e.labelRotation), P = [],
                            T = e.options.gridLines.lineWidth, A = "right" === i.position ? e.left : e.right - T - w,
                        ...
                        if (r.each(m, function (n, a) {
                            ...
                            if (h.display && (a.save(), a.lineWidth = t.glWidth, a.strokeStyle = t.glColor, a.setLineDash && (a.setLineDash(t.glBorderDash), a.lineDashOffset = t.glBorderDashOffset), a.beginPath(), h.drawTicks && (a.moveTo(t.tx1, t.ty1), a.lineTo(t.tx2, t.ty2)), h.drawOnChartArea && (a.moveTo(t.x1, t.y1), a.lineTo(t.x2, t.y2)), a.stroke(), a.restore()), s.display) {
                                ...
                                var i = t.label;
                                if (r.isArray(i)) for (var n = i.length, o = 1.5 * b.size, l = e.isHorizontal() ? 0 : -o * (n - 1) / 2, u = 0; u < n; ++u) a.fillText("" + i[u], 0, l), l += o; else a.fillText(i, 0, 0);
                                a.restore()
                            }
                        }), f.display) {
                            var F, O, L = 0, R = c(f) / 2;
                            if (g) F = e.left + (e.right - e.left) / 2, O = "bottom" === i.position ? e.bottom - R - C.bottom : e.top + R + C.top; else {
            ...
            (e.exports = a.extend({
                initialize: function () {
                    ...
                    var e, i, n, a, s, l, u, c = this, h = c._options, f = c._model, p = c._model = d(h), g = c._active,
                        m = c._data, v = {xAlign: f.xAlign, yAlign: f.yAlign}, b = {x: f.x, y: f.y},
                    ...
                    if (g.length) {
                        ...
                        h.filter && (S = S.filter(function (t) {
                            ...
                            var i = t._chart.ctx, n = 2 * e.yPadding, a = 0, o = e.body, s = o.reduce(function (t, e) {
                    ...
                    var n, a, r, o, s, l, u = i.caretSize, d = i.cornerRadius, c = i.xAlign, h = i.yAlign, f = t.x,
                    ...
                    if (a.length) {
                        ...
                        var o, l, u = e.titleFontSize, d = e.titleSpacing;
                    ...
                    var r = e.xAlign, o = e.yAlign, l = t.x, u = t.y, d = n.width, c = n.height, h = e.cornerRadius;
            ...
            "use strict";
            var n = t(26), a = t(27), r = t(46), o = n.global;
            n._set("global", {
                elements: {
                    line: {
                        tension: .4,
            ...
            "use strict";
            var n = t(26), a = t(27), r = t(46), o = n.global.defaultColor;
            ...
            n._set("global", {
                ...
                inRange: function (t, e) {
                    ...
                    var e = this._view, i = this._model, a = this._chart.ctx, s = e.pointStyle, l = e.rotation,
                        u = e.radius, d = e.x, c = e.y;
                ...
                draw: function () {
                    ...
                    if (l.horizontal ? (t = l.base, e = l.x, i = l.y - l.height / 2, n = l.y + l.height / 2, a = e > t ? 1 : -1, r = 1, o = l.borderSkipped || "left") : (t = l.x - l.width / 2, e = l.x + l.width / 2, i = l.y, a = 1, r = (n = l.base) > i ? 1 : -1, o = l.borderSkipped || "bottom"), u) {
                        var d = Math.min(Math.abs(t - e), Math.abs(i - n)), c = (u = u > d ? d : u) / 2,
                            h = t + ("left" !== o ? c * a : 0), f = e + ("right" !== o ? -c * a : 0),
                            p = i + ("top" !== o ? c * r : 0), g = n + ("bottom" !== o ? -c * r : 0);
                        h !== f && (i = p, n = g), p !== g && (t = h, e = f)
                    }
                    s.beginPath(), s.fillStyle = l.backgroundColor, s.strokeStyle = l.borderColor, s.lineWidth = u;
                    var m = [[t, n], [t, i], [e, i], [e, n]], v = ["bottom", "left", "top", "right"].indexOf(o, 0);
                        ...
                        if (!(isNaN(i) || i <= 0)) {
                            switch (t.save(), t.translate(n, a), t.rotate(r * Math.PI / 180), t.beginPath(), e) {
                                ...
                                case"rect":
                                    ...
                                    break;
                                case"rectRounded":
                                    var h = i / Math.SQRT2, f = -h, p = -h, g = Math.SQRT2 * i;
            ...
            "use strict";
            var n = t(46), a = "$chartjs", r = "chartjs-", o = r + "render-monitor", s = r + "render-animation",
            ...
            function g(t, e, i) {
                var u, d, c, f, g = t[a] || (t[a] = {}), m = g.resizer = function (t) {
                ...
                !function (t, e) {
                    var i = t[a] || (t[a] = {}), r = i.renderProxy = function (t) {
                        t.animationName === s && e()
                    };
                    n.each(l, function (e) {
                        h(t, e, r)
            ...
            function m(t) {
                var e = t[a] || {}, i = e.resizer;
                delete e.resizer, function (t) {
                    var e = t[a] || {}, i = e.renderProxy;
                ...
                _enabled: "undefined" != typeof window && "undefined" != typeof document, initialize: function () {
                    ...
                    if ("resize" !== e) {
                        ...
                        h(r, e, (o.proxies || (o.proxies = {}))[t.id + "_" + e] = function (e) {
                            i(function (t, e) {
                                var i = u[t.type] || t.type, a = n.getRelativePosition(t, e);
            ...
            "use strict";
            var n = t(46), a = t(47), r = t(48), o = r._enabled ? r : a;
            e.exports = n.extend({
                initialize: function () {
            ...
            e.exports = {
                id: "filler", afterDatasetsUpdate: function (t, e) {
                    var i, n, r, o, c = (t.data.datasets || []).length, h = e.propagate, f = [];
                    ...
                    if (i) {
                        ...
                        u && d && l.length && (r.canvas.clipArea(a, t.chartArea), function (t, e, i, n, a, r) {
                            var o, s, l, u, d, f, p, g = e.length, m = n.spanGaps, v = [], b = [], y = 0, x = 0;
            ...
            "use strict";
            var n = t(26), a = t(27), r = t(46), o = t(31), s = r.noop;
            ...
            var u = a.extend({
                initialize: function (t) {
                    ...
                    var t = this, e = t.options, i = e.labels, a = e.display, o = t.ctx, s = n.global,
                        ...
                        f = r.fontString(d, c, h), p = t.legendHitBoxes = [], g = t.minSize, m = t.isHorizontal();
                    if (m ? (g.width = t.maxWidth, g.height = a ? 10 : 0) : (g.width = a ? 10 : 0, g.height = t.maxHeight), a) if (o.font = f, m) {
                        ...
                        var y = i.padding, x = t.columnWidths = [], w = i.padding, k = 0, S = 0, C = d + y;
                    ...
                    var t = this, e = t.options, i = e.labels, a = n.global, o = a.elements.line, s = t.width,
                        u = t.lineWidths;
                    if (e.display) {
                        var d, c = t.ctx, h = r.valueOrDefault, f = h(i.fontColor, a.defaultFontColor),
                            p = h(i.fontSize, a.defaultFontSize), g = h(i.fontStyle, a.defaultFontStyle),
                            m = h(i.fontFamily, a.defaultFontFamily), v = r.fontString(p, g, m);
                        ...
                        r.each(t.legendItems, function (n, l) {
                            var f = c.measureText(n.text).width, g = b + p / 2 + f, m = d.x, v = d.y;
                            x ? m + g >= s && (v = d.y += w, d.line++, m = d.x = t.left + (s - u[d.line]) / 2) : v + w > t.bottom && (m = d.x = m + t.columnWidths[d.line] + i.padding, v = d.y = t.top + i.padding, d.line++), function (t, i, n) {
                                if (!(isNaN(b) || b <= 0)) {
                                    ...
                                    if (c.setLineDash && c.setLineDash(h(n.lineDash, o.borderDash)), e.labels && e.labels.usePointStyle) {
                                        var l = p * Math.SQRT2 / 2, u = l / Math.SQRT2, d = t + u, f = i + u;
            ...
            var l = a.extend({
                ...
                beforeFit: s,
                fit: function () {
                    var t = this, e = r.valueOrDefault, i = t.options, a = i.display,
                        o = e(i.fontSize, n.global.defaultFontSize), s = t.minSize,
                        l = r.isArray(i.text) ? i.text.length : 1, u = r.options.toLineHeight(i.lineHeight, o),
                ...
                draw: function () {
                    var t = this, e = t.ctx, i = r.valueOrDefault, a = t.options, o = n.global;
                    if (a.display) {
                        var s, l, u, d = i(a.fontSize, o.defaultFontSize), c = i(a.fontStyle, o.defaultFontStyle),
                            h = i(a.fontFamily, o.defaultFontFamily), f = r.fontString(d, c, h),
                            p = r.options.toLineHeight(a.lineHeight, d), g = p / 2 + a.padding, m = 0, v = t.top,
                        ...
                        var w = a.text;
                        if (r.isArray(w)) for (var k = 0, S = 0; S < w.length; ++S) e.fillText(w[S], 0, k, s), k += p; else e.fillText(w, 0, 0, s);
                        e.restore()
                    }
                }
            });
            ...
            e.exports = function () {
                var t = n.extend({
                    getLabels: function () {
                        ...
                        if (n.isHorizontal()) {
                            var l = n.width / r, u = l * (e - n.minIndex);
                            return a && (u += l / 2), n.left + Math.round(u)
                        }
                        var d = n.height / r, c = d * (e - n.minIndex);
            ...
            "use strict";
            var n = t(26), a = t(46), r = t(34), o = t(35);
            e.exports = function (t) {
            ...
            "use strict";
            var n = t(46), a = t(33), r = t(34), o = t(35);
            e.exports = function (t) {
                var e = {position: "left", ticks: {callback: o.formatters.logarithmic}}, i = a.extend({
                    determineDataLimits: function () {
                ...
                var p = t.LinearScaleBase.extend({
                    setDimensions: function () {
                        ...
                        this.options.pointLabels.display ? function (t) {
                            var e, i, n, r = l(t), o = Math.min(t.height / 2, t.width / 2),
                            ...
                            for (e = 0; e < g; e++) {
                                ...
                                } : {w: h.measureText(p).width, h: f}, t._pointLabelSizes[e] = i;
                                var m = t.getIndexAngle(e), v = a.toDegrees(m) % 360, b = u(v, n.x, i.w, 0, 180),
                        ...
                        var t = this, i = t.options, n = i.gridLines, r = i.ticks, o = a.valueOrDefault;
                        if (i.display) {
                            ...
                            a.each(t.ticks, function (i, l) {
                                ...
                                var i = t.ctx, n = t.options, r = n.angleLines, o = n.pointLabels;
                                i.lineWidth = r.lineWidth, i.strokeStyle = r.color;
                                var u = t.getDistanceFromCenterForValue(n.ticks.reverse ? t.min : t.max), f = l(t);
                                i.textBaseline = "top";
            ...
            var a = t(26), r = t(46), o = t(33), s = t(34), l = Number.MIN_SAFE_INTEGER || -9007199254740991,
                u = Number.MAX_SAFE_INTEGER || 9007199254740991, d = {
            ...
            function m(t, e) {
                ...
                var i = e.options.time, n = g(e.getRightValue(t), i);
                return n.isValid() ? (i.round && n.startOf(i.round), n.valueOf()) : null
            }

            function v(t) {
                for (var e = c.indexOf(t) + 1, i = c.length; e < i; ++e) if (d[c[e]].common) return c[e]
            }

            function b(t, e, i, a) {
                var o, s = a.time, l = s.unit || function (t, e, i, n) {
                        var a, r, o, s = c.length;
                        for (a = c.indexOf(t); a < s - 1; ++a) if (o = (r = d[c[a]]).steps ? r.steps[r.steps.length - 1] : u, r.common && Math.ceil((i - e) / (o * r.size)) <= n) return c[a];
                        return c[s - 1]
                    }(s.minUnit, t, e, i), h = v(l), f = r.valueOrDefault(s.stepSize, s.unitStepSize),
                    p = "week" === l && s.isoWeekday, g = a.ticks.major.enabled, m = d[l], b = n(t), y = n(e), x = [];
                for (f || (f = function (t, e, i, n) {
                    var a, r, o, s = e - t, l = d[i], u = l.size, c = l.steps;
            ...
            e.exports = function () {
                var t = o.extend({
                    initialize: function () {
                        ...
                        var t, e, i, a, o, s, d = this, c = d.chart, p = d.options.time, g = p.unit || "day", v = u,
                            b = l, y = [], x = [], w = [];
                        for (t = 0, i = c.data.labels.length; t < i; ++t) w.push(m(c.data.labels[t], d));
                        for (t = 0, i = (c.data.datasets || []).length; t < i; ++t) if (c.isDatasetVisible(t)) if (o = c.data.datasets[t].data, r.isObject(o[0])) for (x[t] = [], e = 0, a = o.length; e < a; ++e) s = m(o[e], d), y.push(s), x[t][e] = s; else y.push.apply(y, w), x[t] = w.slice(0); else x[t] = [];
                        ...
                        var t, e, i, a = this, r = a.min, o = a.max, s = a.options, l = s.time, u = [], h = [];
                        ...
                        return a.min = r, a.max = o, a._unit = l.unit || function (t, e, i, a) {
                            ...
                            for (r = c.length - 1; r >= c.indexOf(e); r--) if (o = c[r], d[o].common && s.as(o) >= t.length) return o;
                        ...
                        var a = this.options, o = t.valueOf(), s = a.time.displayFormats, l = s[this._unit],
                            ...
                            f = h.enabled && u && d && o === c, p = t.format(n || (f ? d : l)),
                        ...
                        var e = this, i = e.options.time.displayFormats.millisecond,
                            a = e.tickFormatFunction(n(t), 0, [], i), r = e.getLabelWidth(a),
            ...
            init: function () {
                ...
                function a(t) {
                    var e = t.getBoundingClientRect(), i = document.body, n = document.documentElement,
                        a = window.pageYOffset || n.scrollTop || i.scrollTop, r = n.clientTop || i.clientTop || 0,
                        o = e.top + a - r;
                    return Math.round(o)
                }
    ...
    function o(t) {
        var e, i, n = {top: 0, left: 0}, a = t && t.ownerDocument;
    ...
    var l = {
        duration: 750, delay: 200, show: function (t, e, i) {
            ...
            var d = "scale(" + e.clientWidth / 100 * 3 + ")", c = "translate(0,0)";
    ...
    function d(t, e, i) {
        if (i) {
            ...
            var n = i.getAttribute("data-x"), a = i.getAttribute("data-y"), r = i.getAttribute("data-scale"),
                o = i.getAttribute("data-translate"), u = 350 - (Date.now() - Number(i.getAttribute("data-hold")));
    ...
    return t.init = function (t) {
        ...
        for (var e = {type: "mouseup", button: 1}, i = 0, n = (t = r(t)).length; i < n; i++) l.hide(e, t[i])
...
!function (t) {
    var e, i,
        n = "".concat(["text", "password", "email", "url", "tel", "number", "search", "search-md"].map(function (t) {
            ...
            var e = t(_this);
            if (e.val().length) {
                var i = t(".hiddendiv"), n = e.css("font-family"), a = e.css("font-size");
    ...
    t(n).each(function (e, i) {
        var n = t(i), r = n.siblings("label, i");
        ...
        var i = t(e.target), n = !i.val(), a = !e.target.validity.badInput, o = void 0 === i.attr("placeholder");
        ...
        i.is("form") && (i.find(n).removeClass("valid").removeClass("invalid").each(function (e, i) {
            var n = t(i), a = !n.val(), r = !n.attr("placeholder");
            a && r && n.siblings("label, i").removeClass("active")
        }), i.find("select.initialized").each(function (e, i) {
            var n = t(i), a = n.siblings("input.select-dropdown"), r = n.children("[selected]").val();
            n.val(r), a.val(r)
        }))
    ...
    t(".input-default-wrapper").on("change", ".input-default-js", function (e) {
        var i = t(e.target), n = i.next("label"), a = i[0].files, r = "";
