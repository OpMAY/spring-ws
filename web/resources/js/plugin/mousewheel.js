...
!function(a) {
  ...
  function b(b) {
    const g = b || window.event; const h = i.call(arguments, 1); let j = 0; let l = 0; let m = 0; let n = 0; let o = 0; let p = 0;
  ...
  let e; let f; const g = ['wheel', 'mousewheel', 'DOMMouseScroll', 'MozMousePixelScroll'];
  ...
  var k = a.event.special.mousewheel = {
    version: '3.1.12', setup: function() {
      ...
      const c = a(b); let d = c['offsetParent' in a.fn ? 'offsetParent' : 'parent']();
...
/* Mousewheel in horizontal list  */
/** 사용법
 * setMouseWheel({'id',false,true,new function(){...}})
 * */

function setMousewheel(
    {
      id, isClass = false, prevent = true,
  ...
  if (id !== undefined && id !== null) {
    ...
    console.log('setMousewheel is not element by ' + id);
  }
}
