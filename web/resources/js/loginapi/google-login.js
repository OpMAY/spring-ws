...
const googleRestLoginFunction = () => {
    let h = 'https://accounts.google.com/o/oauth2/v2/auth';
    let c = $('#GOOGLE_KEY').val();
    let r = window.location.protocol + "//" + window.location.host + callBackURI2
    let t = 'code';
    let s = 'email,name,profile'; // 받아올 정보 목록
